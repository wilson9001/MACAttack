...
class Sha1Hash(object):
    ...
    def __init__(self, initializationVector= (0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0), messageByteLength = 0):
        # Initial digest variables
        self._h = initializationVector

        # bytes object with 0 <= len < 64 used to store the end of the message
        # if the message length is not congruent to 64
        self._unprocessed = b''
        # Length in bytes of all data that has been processed so far
        self._message_byte_length = messageByteLength
...
def sha1(data, initializationVector = (0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0), messageByteLength = 0):
    ...
    """
    return Sha1Hash(initializationVector, messageByteLength).update(data).hexdigest()
